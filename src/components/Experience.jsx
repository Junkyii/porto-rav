...
import { Briefcase, Award, ZoomIn } from 'lucide-react';
...
export default function Experience() {
  ...
  return (
        ...
        <div className="space-y-8">
          {experiences.map((exp, index) => (
            <div key={index} className="group relative">
               ...
               <Card className="relative hover:border-white/20 hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-1">
                 <CardContent className="p-6 md:p-8">
                   <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                     ...
                     <div className="flex flex-col items-start md:items-end">
                       <Badge variant="outline" className="font-mono text-gray-400 group-hover:border-white/20">{exp.period}</Badge>
                   ...
                   <div className="flex flex-col md:flex-row gap-6 mb-6">
                     <div className="flex-1">
                       ...
                       <div className="flex flex-wrap gap-2">
                         {exp.tags.map((tag, i) => (
                           <Badge key={i} variant="secondary" className="group-hover:bg-white/20">
                             {tag}
                           </Badge>
                         ))}
                       </div>
    ...
    {/* Certificate Modal - shadcn Dialog */}
      ...
      <DialogContent>
        <DialogHeader className="flex-row items-center gap-3">
          ...
          <div>
            ...
            <DialogDescription>Soca AI — Quality Assurance Internship</DialogDescription>
          </div>
        </DialogHeader>
    ...
    {/* Work Image Modal - shadcn Dialog */}
    <Dialog open={showWorkImg} onOpenChange={setShowWorkImg}>
      <DialogContent className="max-w-4xl">
        <DialogHeader className="flex-row items-center gap-3">
          <Briefcase size={20} className="text-blue-400" />
          <div>
            <DialogTitle>QA Testing Work</DialogTitle>
            <DialogDescription>Soca AI — Quality Assurance</DialogDescription>
          </div>
        </DialogHeader>
        <div className="px-6 pb-6">
          <div className="rounded-xl overflow-hidden border border-white/10">
