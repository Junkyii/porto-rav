      ...
      <RevealOnScroll className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {skills.map((skillGroup, index) => (
            <Card key={index} className="hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/10 hover:-translate-y-1">
              <CardHeader className="pb-2">
                <CardTitle className="text-xl text-center">{skillGroup.category}</CardTitle>
              </CardHeader>
              <CardContent>
