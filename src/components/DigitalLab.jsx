...
export default function DigitalLab() {
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/5 rounded-2xl p-5 md:p-6 border border-white/10 hover:border-white/20 hover:shadow-xl hover:shadow-green-500/5 transition-all duration-300 hover:-translate-y-1">
